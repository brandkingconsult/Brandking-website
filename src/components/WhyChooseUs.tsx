    ...
    <section className="mt-[150px] py-[80px] w-full">
      <Container className="flex flex-col items-center gap-[30px]">
        ...
        <div className="flex flex-col md:grid w-full gap-5 mx-auto max-w-[1200px]" style={{ gridTemplateColumns: "repeat(3, 1fr)" }}>
          ...
          <div className="rounded-[10px] flex flex-col p-5 gap-[20px] bg-surface border border-stroke/10 md:h-[250px] h-auto overflow-hidden">
            ...
            <div className="rounded-[10px] flex-1 bg-placeholder w-full h-[150px] md:h-full relative overflow-hidden">
          ...
          <div className="rounded-[10px] flex flex-col p-5 gap-[20px] bg-surface border border-stroke/10 md:h-[250px] h-auto overflow-hidden">
             <div className="rounded-[10px] bg-placeholder flex-1 w-full h-[150px] md:h-full relative overflow-hidden order-last md:order-first">
          ...
          <div className="rounded-[10px] flex flex-col p-5 gap-[20px] bg-surface border border-stroke/10 md:h-[520px] h-auto overflow-hidden" style={{ gridRow: "1 / 3" }}>
            <div className="flex flex-col gap-2 flex-shrink-0">
            ...
            <div className="rounded-[10px] bg-placeholder flex-1 w-full h-[250px] md:h-full relative overflow-hidden">
          ...
          <div className="rounded-[10px] flex flex-col md:flex-row items-center p-5 gap-[30px] bg-surface border border-stroke/10 md:h-[250px] h-auto overflow-hidden" style={{ gridColumn: "1 / 3" }}>
            ...
            <div className="rounded-[10px] w-full flex-1 md:h-full h-[150px] bg-placeholder relative overflow-hidden">
